...
$_DB_Query_Kernel_Security_Update_Member_Account_Force_Logout			= $DB->query("UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_security_setting_flag_force_logout='0' WHERE member_username='$_GLOBAL_COOKIE_MEMBER_USERNAME'");
...
**/
	...
	header("Location: ?$_INTERNAL_APPLICATION_MODULE_INTERNAL=Logout"); // Fake Data Found In Credential Cookies - Redirect To Logout Section, Destroy All Cookies
	exit;
...
$_DB_Query_Kernel_Networking_Status_Security_Check_Blocked_Networks				= $DB->query("SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_networking ORDER BY id ASC");
$_DB_Query_Kernel_Networking_Status_Security_Check_Blocked_Networks_Fetch_Array			= $DB->fetch_array($_DB_Query_Kernel_Networking_Status_Security_Check_Blocked_Networks);
...
$DB->free($_DB_Query_Kernel_Networking_Status_Security_Check_Blocked_Networks);
...
$_DB_Query_Kernel_Update_Member_Rank 							= $DB->query("UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_level_rank='$_Kernel_Member_Rank_Level_Update_Digit' WHERE member_username='$_GLOBAL_COOKIE_MEMBER_USERNAME'");
...
<!--==============================-->
	...
	<HEAD>
		...
		<LINK REL=\"stylesheet\" HREF=\"./Theme/$_GLOBAL_SYSTEM_THEME_DIRECTORY/Style_Sheet/Style.css?$_GLOBAL_SYSTEM_SECURITY_IMAGE_RANDOM_STRING_GENERATION_CACHE_CIRCUMVENTION\" TYPE=\"text/css\">
